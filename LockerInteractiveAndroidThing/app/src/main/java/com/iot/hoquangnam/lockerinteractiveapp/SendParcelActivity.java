...
public class SendParcelActivity extends AppCompatActivity {
    ...
    private EditText ShipperIDInput;
    private StringBuilder buffer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_otp);
        getSupportActionBar().setTitle("Gửi gói hàng");
        OTPInput = (EditText) findViewById(R.id.OTPCodeInput);
        ShipperIDInput = (EditText) findViewById(R.id.IDInput);
        ShipperIDInput.setHint("Xin vui lòng nhập mã nhân viên");
        ...
        BtnActivityParcel.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                final String sShipperIDInput = ShipperIDInput.getText().toString();
                try {
                    String reponse = new PostJSONRequest(SendParcelActivity.this).execute(
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(SendParcelActivity.this);
                        ...
                        builder.setPositiveButton("Xác nhận", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    ...
                                    String reponse = new PostJSONRequest(SendParcelActivity.this).execute(
                                            "http://assignmentiot.atwebpages.com/myworkspace/IOT/web/shipper-confirm.php",
                                            "OTP",
                                            sOTPInput,
                                            "shipperId",
                                            sShipperIDInput,
                                ...
                                Intent myIntent = new Intent(SendParcelActivity.this, MainActivity.class);
